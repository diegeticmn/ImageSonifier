  ...
  for (let i = 0; i < orderedByColor.length; i++) {
    ...
    if (hslColors[i].h) {
      ...
      function hexToRgb(hex) {
          inthex = hex.substring(1);
          var bigint = parseInt(inthex, 16);
          var r = (bigint >> 16) & 255;
          var g = (bigint >> 8) & 255;
          var b = bigint & 255;
        ...
        domColor = hexToRgb(rgbToHex(orderedByColor[0]));
...
const main = () => {
  ...
  document.getElementById("explain").textContent = 'The music you are hearing was made from the colors in your drawing. This is your song.';
